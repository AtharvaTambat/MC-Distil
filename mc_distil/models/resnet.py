...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', class_num=10):
        ...
        self.fc = nn.Linear(num_filters[3] * block.expansion, class_num)

        self.conv_channels = [ num_filters[3]  ]
        self.xchannels   = [ num_filters[3] *block.expansion ] 
...
def get_resnet_models(config, name, **kwargs):
    if name == 'resnet8x4': return  resnet8x4( **kwargs )
    if name == 'resnet32x4': return  resnet32x4( **kwargs )
    if name == 'resnet20': return  resnet20( **kwargs )
    if name == 'resnet32': return  resnet32( **kwargs )
    if name == 'resnet56': return  resnet56( **kwargs )
    if name == 'resnet110': return  resnet110( **kwargs )

    if name == 'wrn_40_1': return  resnet38( **kwargs )
    if name == 'wrn_40_2': return  resnet38x2( **kwargs )
    if name == 'wrn_16_2': return  resnet14x2( **kwargs )
